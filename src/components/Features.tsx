  ...
  return <section id="recursos" className="py-24 bg-secondary/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          return <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/20 animate-slide-up bg-gradient-card" style={{
