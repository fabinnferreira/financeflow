      ...
      <div className="container relative z-10 mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <p className="text-xl leading-relaxed max-w-xl text-emerald-50">Transforme sua relação com o dinheiro. Organize receitas, despesas e investimentos em um só lugar. Sua decisões financeiras mais inteligentes começam aqui.</p>
