      ...
      <div className="container relative z-10 mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-foreground py-px">Gerencie Suas<span className="block bg-gradient-to-r from-primary to-success bg-clip-text text-transparent">Finanças Pessoais</span>
              com inteligência
            </h1>

            <p className="text-xl leading-relaxed max-w-xl text-destructive-foreground">Transforme sua relação com o dinheiro. Organize receitas, despesas e investimentos em um só lugar. Sua decisões financeiras mais inteligentes começam aqui.</p>

            <div className="flex flex-col sm:flex-row gap-4">
              <Button variant="hero" size="xl" className="group" asChild>
                <Link to="/auth" className="text-primary-glow">COMEÇAR GRATUITAMENTE<ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Link>
              </Button>
